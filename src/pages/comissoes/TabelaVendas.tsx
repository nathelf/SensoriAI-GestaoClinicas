...
export default function TabelaVendas() {
  const { data, loading, create, update, remove } = useCrud<CommissionRate>({ table: "commission_rates_sales" });
    ...
    <div className="p-4 lg:p-6 max-w-5xl mx-auto">
      <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
        ...
        {loading ? (
          ...
          <div className="text-center py-12 text-muted-foreground text-sm">Nenhuma regra de comissão de vendas cadastrada.</div>
        ) : (
